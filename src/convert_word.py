...
doc.add_paragraph('(Inserta tu captura de la lista de exámenes aquí)')
doc.add_paragraph('(Inserta tu captura del detalle de un examen aquí)')
doc.add_paragraph('(Inserta tu captura del formulario de preguntas aquí)')
doc.add_paragraph('(Inserta tu captura de la base de datos o administrador aquí)')
...
doc.add_paragraph('(Inserta la captura de la estructura de carpetas de VS Code aquí)')
